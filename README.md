...
- **Control features** — drive the phone from your mouse and keyboard. Pair
  the phone over Bluetooth and turn on Settings → Accessibility → Zoom on it.
  See the [guide](docs/raspberry-pi.md#5-control-features).
